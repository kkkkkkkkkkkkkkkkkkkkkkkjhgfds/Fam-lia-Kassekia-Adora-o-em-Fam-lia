  ...
  <section id="startScreen" class="screen active">
    <div class="hero">
      <div class="panel hero-copy">
        ...
        <div class="setup">
          <div class="field"><label for="player">Quem és?</label><select id="player"><option>Pedro</option><option>Gerson</option><option selected>Kassékia</option><option>Feleciana</option><option>Simão</option></select></div>
        ...
        <div class="sync-note"><b>Preparação em 3 passos:</b> enviem este mesmo ficheiro a Pedro, Gerson, Kassékia, Feleciana e Simão; cada um abre no navegador e escolhe o próprio nome; todos mantêm o código <code>FAMILIA-ZUA</code> e a mesma duração. Assim, as rondas ficam iguais em todos os aparelhos.</div>
...
const PLAYERS=['Pedro','Gerson','Kassékia','Feleciana','Simão'];
const roleTasks=[
